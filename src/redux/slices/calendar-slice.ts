...
import {
  ...
  decreaseByOneMonth,
  increaseByOneMonth,
} from '../../services/calendar-service/calendar-service';

import { getWorkoutsBetweenIntervals } from '../../services/api-service/api-service';

// interfaces & types
import { Calendar } from '../../ts/types/calendar';
import { Workout } from '../../ts/interfaces/workout-interfaces';
import { RootState } from '../store';
import { sortByDate } from '../../services/workout-service/workout-service';
...
export const calendarSlice = createSlice({
  ...
  reducers: {
    ...
    deleteFromCalendarWorkouts: (state, action: PayloadAction<string>) => {
      ...
      state.calendarWorkouts = state.calendarWorkouts.filter((workout) => workout._id !== deletedWorkoutId);
    },
  },
